...
Future<void> showEditStaffVendorDialog(BuildContext context, Map<String, dynamic> staff, VoidCallback onStaffUpdated) {
  return showDialog(
    context: context,
    builder: (context) => EditStaffVendorDialog(staff: staff, onStaffUpdated: onStaffUpdated),
  );
}
...
class EditStaffVendorDialog extends StatefulWidget {
  ...
  const EditStaffVendorDialog({super.key, required this.staff, required this.onStaffUpdated});
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('Edit Staff', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
              ...
              Row(
                ...
                children: [
                  OutlinedButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel', style: TextStyle(color: Colors.black54))),
                  const SizedBox(width: 10),
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF1A365D), foregroundColor: Colors.white),
                    onPressed: () {
                      Navigator.pop(context);
                      widget.onStaffUpdated(); // TODO: Link database API kemaskini data staff vendor
                    },
