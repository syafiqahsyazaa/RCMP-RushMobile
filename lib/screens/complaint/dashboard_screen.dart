...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _tarikDataAduanDashboard() async {
    ...
    final url = Uri.parse(
        'http://$domain/helpdesk_api/get_my_complaints.php?email=${currentLoggedInUserEmail!.trim()}');
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          _senaraiAduanSaya.length
                              .toString(), // Auto-mengira bilangan aduan aktif real-time anda!
                    ...
                    PopupMenuItem<void>(
                      ...
                      child: StatefulBuilder(
                        builder:
                          ...
                          List<dynamic> senaraiNotifUserLiveDB =
                              _senaraiAduanSaya;
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                          '${senaraiNotifUserLiveDB.length} active',
                                          style: const TextStyle(
                                              fontSize: 9.5,
                                              fontWeight: FontWeight.bold,
                                              color: AppColors.navy)),
                                ...
                                senaraiNotifUserLiveDB.isEmpty
                                    ...
                                    : ConstrainedBox(
                                        ...
                                        child: ListView.separated(
                                          ...
                                          itemCount:
                                              senaraiNotifUserLiveDB.length,
                                          separatorBuilder: (context, index) =>
                                              const SizedBox(height: 8),
                                          itemBuilder: (context, index) {
                                            final aduan =
                                                senaraiNotifUserLiveDB[index];
                                            String ticketIdReal =
                                                (aduan['ticket_id'] ?? 'No ID')
                                                    .toString();
                                            String statusLabelReal =
                                                (aduan['status'] ?? 'open')
                                                    .toString()
                                                    .toLowerCase()
                                                    .trim();

                                            String statusDipaparTeks =
                                                statusLabelReal == 'in_progress'
                                                    ? 'In Progress'
                                                    : (statusLabelReal ==
                                                            'closed'
                                                        ? 'Closed'
                                                        : 'Open');
                                            String ikonStatusEmoji =
                                                statusLabelReal == 'in_progress'
                                                    ? '⏳'
                                                    : (statusLabelReal ==
                                                            'closed'
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                Navigator.pop(
                                                    context); // Auto-tutup popup menu loceng!
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          const SizedBox(
                                                              height: 3),
                                                          Text(
                                                              '$ikonStatusEmoji Ticket marked as $statusDipaparTeks',
                                                              style: const TextStyle(
                                                                  fontSize: 11,
                                                                  color: AppColors
                                                                      .textSecondary,
                                                          ...
                                                          const SizedBox(
                                                              height: 4),
                                                          Text(
                                                              '${aduan['my_department'] ?? "IT Dept"} · ${aduan['created_at'] ?? "Just Now"}',
                                                              style: const TextStyle(
                                                                  fontSize: 9.5,
                                                                  color: Colors
                                                                      .grey)),
              ...
              child: PopupMenuButton(
                ...
                itemBuilder: (BuildContext context) {
                  ...
                  String namaUserTulenLive = _senaraiAduanSaya.isNotEmpty
                      ? (_senaraiAduanSaya[0]['submitter_name'] ??
                          'User Complainant')
                      : 'User Complainant';
                        ...
                        children: [
                          ...
                          Text(
                            currentLoggedInUserEmail ??
                                'user@gmail.com', // apply EMAL LIVE SESSION JABATAN!
                            style: const TextStyle(
                              fontSize: 11,
                ...
                children: [
                  ...
                  if (_isLoading)
                    ...
                    const Padding(
                      ...
                      child: Center(
                          child: Text('No recent complaints found.',
                              style:
                    ...
                    ..._senaraiAduanSaya.map((aduan) {
                      ...
                      String tarikhMentah =
                          (aduan['created_at'] ?? '').toString().trim();
                      String tarikhDipapar = 'No Date';

                      //  KUNCI FAIL-SAFE: Memastikan data substring terselamat dari RangeError
                      try {
                        if (tarikhMentah.isNotEmpty &&
                            tarikhMentah.length >= 10) {
                          String ymd = tarikhMentah.substring(0, 10);
                          List<String> susunan = ymd.split('-');
                          if (susunan.length == 3) {
                            tarikhDipapar =
                                "${susunan[2]}-${susunan[1]}-${susunan[0]}";
                          }
                        } else if (tarikhMentah.isNotEmpty) {
                          tarikhDipapar =
                              tarikhMentah; // Fallback jika teks pendek
                        }
                      } catch (e) {
                        tarikhDipapar =
                            'Just Now'; // Jika parsing gagal, paksa paparkan Just Now
                      }
