...
Future<void> showDeleteStaffDialog(BuildContext context,
    {required String staffName, required String staffCode}) async {
  return showDialog<void>(
    context: context,
    builder: (BuildContext context) {
      return _DeleteStaffDialogContent(
          staffName: staffName, staffCode: staffCode);
    },
  );
}
...
class _DeleteStaffDialogContent extends StatefulWidget {
  ...
  const _DeleteStaffDialogContent(
      {required this.staffName, required this.staffCode});

  @override
  State<_DeleteStaffDialogContent> createState() =>
      _DeleteStaffDialogContentState();
}
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  const TextSpan(
                      text:
                          ' and cannot be undone. The staff member will be completely removed from the unicomplaint help desk system.'),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                      child: Text(
                          'Make sure all open tickets are reassigned before deleting.',
                          style: TextStyle(
                              fontSize: 11,
              ...
              children: [
                ...
                _isDeleting
                    ...
                    : ElevatedButton(
                        ...
                        child: const Text('Yes, Delete Staff',
                            style: TextStyle(
