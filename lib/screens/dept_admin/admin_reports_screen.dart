                      ...
                      children: [
                        ...
                        _buildReportCardContainer(
                          ...
                          statsRow: Row(
                            children: [
                              _buildStatBox(
                                  _vendorData['total_vendors']?.toString() ??
                                      '2',
                                  "TOTAL VENDORS"),
                              _buildVerticalDivider(),
                              _buildStatBox(
                                (() {
                                  try {
                                    final List<dynamic>?
                                        senaraiPerformanceVendorLive =
                                        _vendorData['performance']
                                            as List<dynamic>?;
                                    if (senaraiPerformanceVendorLive != null &&
                                        senaraiPerformanceVendorLive
                                            .isNotEmpty) {
                                      int jumlahTotalResolveVendorLive = 0;
                                      for (var item
                                          in senaraiPerformanceVendorLive) {
                                        if (item is Map &&
                                            item['value'] != null) {
                                          jumlahTotalResolveVendorLive +=
                                              int.parse(
                                                  item['value'].toString());
                                        }
                                      }
                                      return jumlahTotalResolveVendorLive
                                          .toString();
                                    }
                                  } catch (e) {
                                    print(
                                        "Ralat hitung total resolve vendor: $e");
                                  }
                              ...
                              _buildVerticalDivider(),
                              _buildStatBox(
                                  _vendorData['tickets_assigned']?.toString() ??
                                      '2',
                                  "ASSIGNED TASKS"),
                            ],
                          ),
                          chartChild: _buildVerticalBars(
                              List.from(_vendorData['performance'] ??
                                  [
