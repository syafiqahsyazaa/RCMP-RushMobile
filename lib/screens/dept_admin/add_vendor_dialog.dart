...
Future<void> showAddVendorDialog(BuildContext context,
...
class _AddVendorDialogState extends State<AddVendorDialog> {
  ...
  final _picPositionCtrl =
      TextEditingController(); // Position Controller for vendor_staff
      ...
      if (respon.statusCode == 200) {
        ...
        if (hasil['status'] == 'berjaya') {
          if (mounted) {
            ...
            String passwordUnikBaru =
                hasil['temp_password'] ?? 'Gagal Janu Password';
          ...
          ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(hasil['mesej'] ?? 'Failed.')));
        }
      }
    } catch (e) {
                  ...
                  child: Column(
                    children: [
                      ...
                      const Align(
                          ...
                          child: Text('Person In Charge (PIC)',
                              style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.bold,
                                  color: AppColors.textPrimary))),
                      ...
                      const InfoBanner(
                        ...
                        title:
                            'This vendor will automatically be sent an invitation email to activate their account once added.',
                      ),
                    ],
                  ),
                ),
